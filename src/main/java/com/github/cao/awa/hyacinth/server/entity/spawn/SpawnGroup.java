package com.github.cao.awa.hyacinth.server.entity.spawn;
 ...
 * {@link #MISC} group.
 *
 * @see com.github.cao.awa.hyacinth.server.entity.EntityType#getSpawnGroup()
...
public enum SpawnGroup implements StringIdentifiable {
    ...
    SpawnGroup(String name, int spawnCap, boolean peaceful, boolean rare, int immediateDespawnRange) {
        this.name = name;
