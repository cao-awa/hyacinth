...
.register(HandshakeC2SPacket.class, HandshakeC2SPacket::new)
    ...
    PLAY(0, NetworkState.createPacketHandlerInitializer().setup(
            NetworkSide.CLIENTBOUND, new PacketHandler<ClientPlayPacketListener>()
...
//                    .register(ScoreboardPlayerUpdateS2CPacket.class, ScoreboardPlayerUpdateS2CPacket::new)
                    ...
                    .register(TitleS2CPacket.class, TitleS2CPacket::new).register(TitleFadeS2CPacket.class, TitleFadeS2CPacket::new)
