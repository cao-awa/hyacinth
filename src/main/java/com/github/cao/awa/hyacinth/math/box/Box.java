package com.github.cao.awa.hyacinth.math.box;
...
public class Box {
    ...
    public Vec3d getCenter() {
        return new Vec3d(Mathematics.lerp(0.5, this.minX, this.maxX), Mathematics.lerp(0.5, this.minY, this.maxY), Mathematics.lerp(0.5, this.minZ, this.maxZ));
    }
