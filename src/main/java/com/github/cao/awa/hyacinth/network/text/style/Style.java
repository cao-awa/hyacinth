...
import com.github.cao.awa.hyacinth.network.text.event.ClickEvent;
...
/**
 * The style of a {@link com.github.cao.awa.hyacinth.network.text.Text}, representing cosmetic attributes. It includes
 * font, formatting, click/hover events (actions), color, etc.
 *
 * <p>A style is immutable.
 *
 * @see com.github.cao.awa.hyacinth.network.text.Text
 */
public class Style {
    /**
     * An empty style.
