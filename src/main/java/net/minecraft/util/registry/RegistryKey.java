...
public class RegistryKey<T> {
    ...
    private static <T> RegistryKey<T> of(Identifier registry, Identifier value) {
        ...
        return (RegistryKey<T>) INSTANCES.computeIfAbsent(string2, string -> new RegistryKey(registry, value));
    }
    ...
    public <E> Optional<RegistryKey<T>> method_39752(RegistryKey<? extends Registry<E>> registryKey) {
