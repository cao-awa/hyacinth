...
extends LongLinkedOpenHashSet {
    ...
    extends Long2LongLinkedOpenHashMap {
        private static final int STARTING_OFFSET = Mathematics.floorLog2(60000000);
        private static final int HORIZONTAL_COLUMN_BIT_SEPARATION = Mathematics.floorLog2(60000000);
